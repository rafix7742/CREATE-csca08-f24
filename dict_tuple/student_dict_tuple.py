...
'''The following fucntion is already implemented but missing its helper
implement the helper (see above) and create the docstring for this function

The intended functionality is to get the overall winner of the competition,
i.e who had the fastest total time
'''
